...
class Config(basicConfig):
    def __init__(self, case, pmid):
        ...
        self.pmid2go = os.path.join(basicConfig.DB_PATH, 'GO2/TCGA/{}_pubmed2go.csv'.format(case))
        self.pmid2gene = os.path.join(basicConfig.DB_PATH, 'Gene2/TCGA/{}_pubmed2gene.csv'.format(case))
